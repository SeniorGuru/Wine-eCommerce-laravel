    ...
    <div class="container mb-3">
        <div class="d-flex justify-content-between">
            <div class = "page-list font-weight-bold text-default">
                <a class="text-default" href="{{route('home')}}">{{__('wine.Home')}}</a>&nbsp>&nbsp<a class="text-default" href="{{route('findWine')}}">{{__('wine.findWine')}}</a>&nbsp>&nbsp{{$row->full_product_name}}
            </div>
