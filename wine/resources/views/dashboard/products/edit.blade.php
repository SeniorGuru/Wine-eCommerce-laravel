                            ...
                            <form method="POST" action="/admin/products/{{ $product->product_code }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <input disabled class="form-control" type="text" placeholder="" name="maker_japanese" value="{{ $product->maker_name }}" required autofocus>
                                    </div>
                                    <div class="col-md-6 mb-1">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        <label>{{__('wine.full product name')}}</label>
