...
//                $element = DB::table('maker_tmp')->where('id', $maker->foreign_maker_id)->first();
//                if(isset($element->email)){
//                    DB::table('foreign_maker')->where('foreign_maker_id',$maker->foreign_maker_id)
//                        ->update([
////                            'maker_phone'=>$element->phone,
////                            'maker_fax'=>$element->fax,
////                            'maker_address'=>$element->address,
////                            'maker_url'=>$element->url,
//                            'maker_email'=>$element->email
//                        ]);
//                }
//            }
